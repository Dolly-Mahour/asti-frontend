    ...
    <>
      <div className="h-auto shadow border p-4">
        ...
        <div className="border rounded-4 shadow-sm mt-4 w-100">
          ...
          >
            {[
              { color: "#a12b2bff", label: "Required" },
              { color: "#b30808ff", label: "Allocation" },
              { color: "#bd3c3cff", label: "Actual Present" },
            ].map(({ color, label }) => (
